...
export function darkShows(which) {
  if (which === 2) {
    return [
      ...
      { x: 1.4, z: 3.8, w: 1.6, h: 2.2, d: 0.3, t0: 0.7, t1: 0.92 },
    ];
  }
  return [
    { x: 1.4, z: -1.2, w: 0.9, h: 2.2, d: 0.3, t0: 0.08, t1: 0.32 },
    { x: 1.4, z: 1.6, w: 1.1, h: 1.6, d: 0.5, t0: 0.28, t1: 0.55 },
    { x: -1.1, z: 1.8, w: 0.8, h: 2.4, d: 0.3, t0: 0.5, t1: 0.8 },
  ];
}
